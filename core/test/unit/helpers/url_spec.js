...
<<<<<<< HEAD
    it('should pass through protocol-less URLs regardless of absolute setting', function () {
        rendered = helpers.url.call(
            {url: '//aquarius.website/baz', label: 'Baz', slug: 'baz', current: true},
            {hash: {}});
        should.exist(rendered);
        rendered.string.should.equal('//aquarius.website/baz');
...
>>>>>>> 15a3dacf26158ac9789977692e59e51a0e808270
    ...
    describe('with subdir', function () {
        ...
        it('external urls should be retained in a nav context with subdir', function () {
            rendered = helpers.url.call(
                {url: 'http://aquarius.website/baz', label: 'Baz', slug: 'baz', current: true},
                {hash: {absolute: 'true'}});
            should.exist(rendered);
            rendered.string.should.equal('http://aquarius.website/baz');
        });
